...
/**
 * Shared favorites functional component.
            ...
            <div className='justify-center items-center text-gray-500 overflow-y-auto '>
                <ul className='items-center z-[100] '>
                    {episodes.map((episode, index) => (
                        <li key={index} className='border border-purple-500 bg-black rounded m-4 flex justify-between items-center text-yellow-400 '>
                            <div className="flex flex-col sm:flex-row items-center">
                                <div>
                                    <img src={episode.season_image} alt={episode.season_title} className='w-52 h-full m-4'/>
                                </div>
                                <div className="flex flex-col ml-6">
                                    ...
                                    <div className=' flex items-center m-2 mb-3 text-amber-50'>
